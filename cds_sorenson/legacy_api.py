...
from .utils import filepath_for_samba, generate_json_for_encoding, get_status

warnings.warn(
    "This API is deprecated. Use it at your own risk!",
    DeprecationWarning)
...
def start_encoding(input_file, output_file, desired_quality,
    ...
    :returns: job ID.
    """
    input_file = filepath_for_samba(input_file)
    output_file = filepath_for_samba(output_file)
